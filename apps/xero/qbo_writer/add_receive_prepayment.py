        ...
        for i in range(0, len(QuerySet1)):
            ...
            for j in range(0, len(QuerySet1[i]["Line"])):
                ...
                if QuerySet1[i]["Line"][j]["LineAmount"] >= 0:
                    ...
                    #     if QBO_Customer[v1]["DisplayName"].startswith(QuerySet1[i]["ContactName"]) and QBO_Customer[v1]["DisplayName"].endswith(" - C"):
                    #         EntityRef['value'] = QBO_customer[v1]['Id']
                    #         EntityRef['name'] = QBO_customer[v1]['DisplayName']
                    #         Entity['Type'] = 'Customer'

                    #     elif (QuerySet1[i]["ContactName"] == QBO_customer[v1]['DisplayName']) :
                    #         EntityRef['value'] = QBO_customer[v1]['Id']
                    #         EntityRef['name'] = QBO_customer[v1]['DisplayName']
                    #         Entity['Type'] = 'Customer'
