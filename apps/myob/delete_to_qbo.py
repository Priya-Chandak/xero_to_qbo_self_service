...
from apps.util.qbo_util import post_data_in_qbo,post_data_in_myob
...
def delete_qbo_data(job_id,task_function_name,task_id):
    ...
    elif json_object_key in ['Bill','Invoice','CreditMemo','VendorCredit','Purchase','Deposit','BillPayment','Payment','JournalEntry','Transfer']:
        for g1 in range(0,len(a1)):
            e={}
            e['is_pushed']=0
            e['Id'] = a1[g1]['Id']
