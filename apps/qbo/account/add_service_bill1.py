            ...
            if 'account' in final_bill[i]:
                ...
                if final_bill[i]['Total_Amount'] >= 0:
                        ...
                        for j in range(0, len(final_bill[i]['account'])):
                            if 'Item_name' in final_bill[i]['account'][j]:
                                ...
                                for k1 in range(0, len(QBO_tax)):
                                    if (final_bill[i]['account'][j]['Tax_Code'] == 'GST') or (
                                            final_bill[i]['account'][j]['Tax_Code'] == 'GCA'):
                                    ...
                                    if (final_bill[i]['account'][j]['Tax_Code'] == 'N-T') or (
                                    ...
                                    elif (final_bill[i]['account'][j]['Tax_Code'] == 'GNR') or (
                                            final_bill[i]['account'][j]['Tax_Code'] == 'FRE'):
                                        if 'taxrate_name' in QBO_tax[k1]:
                                ...
                                if ('Comment' in final_bill[i]) and ('supplier_invoice_no' in final_bill[i]):
                                    if (final_bill[i]['supplier_invoice_no'] != None) and (
                                            final_bill[i]['supplier_invoice_no'] != "") and (
                                            final_bill[i]['Comment'] != None) and (final_bill[i]['Comment'] != ""):
                                        QuerySet['PrivateNote'] = final_bill[i][
                                                                      'Comment'] + " Supplier Invoice Number is:" + \
                                    ...
                                    if final_bill[i]['supplier_invoice_no'] != None:
                                        QuerySet['PrivateNote'] = " Supplier Invoice Number is:" + final_bill[i][
                                            'supplier_invoice_no']
                                ...
                                for j1 in range(0, len(QBO_item)):
                                    if 'Item_name' in final_bill[i]['account'][j]:
                                        if final_bill[i]['account'][j]['Item_name'].lower().strip() == QBO_item[j1][
                                            "Name"].lower().strip():
                                ...
                                for j3 in range(0, len(QBO_supplier)):
                                    if final_bill[i]['Supplier_Name'].lower().strip() == QBO_supplier[j3][
                    ...
                    if len(final_bill[i]['account']) >= 1:
                        ...
                        for j in range(0, len(final_bill[i]['account'])):
                            ...
                            if final_bill[i]['Is_Tax_Inclusive'] == True:
                                ...
                                QuerySet1['Amount'] = abs(
                                    final_bill[i]['account'][j]['Quantity'] * final_bill[i]['account'][j]['Unit_Price'])
                                TaxLineDetail['NetAmountTaxable'] = abs(
                        ...
                        if (start_date != '' and end_date != ''):
                            if (bill_date1 >= start_date1) and (bill_date1 <= end_date1):
                                post_data_in_qbo(url2, headers, payload, final_bill, _id, job_id, task_id,
                                                 final_bill[i]['invoice_no'])
