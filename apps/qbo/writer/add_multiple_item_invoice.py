            ...
            for j in range(len(multiple_invoice[i]['Item'])):
                ...
                if "DisplayID" in multiple_invoice[i]['Item'][j]:
                    ...
                    for p3 in range(0, len(QBO_item)):
                        ...
                        if 'item_name' in multiple_invoice[i]['Item'][j] and 'DisplayID' in multiple_invoice[i]['Item'][j]: 
                            if multiple_invoice[i]['Item'][j]['item_name']+"-"+multiple_invoice[i]['Item'][j]['DisplayID'] == QBO_item[
                                    p3]['Name']:
                                ItemRef['name'] = QBO_item[p3]['Name']
                                ItemRef['value'] = QBO_item[p3]['Id']
                                break
                            elif multiple_invoice[i]['Item'][j]['item_name'].lower().strip()== QBO_item[p3]['Name'].lower().strip():
                                ItemRef['name'] = QBO_item[p3]['Name']
                                ItemRef['value'] = QBO_item[p3]['Id']
                                continue
                            else:
                                if multiple_invoice[i]['Item'][j]['item_name'].replace(":","-")== QBO_item[p3]['Name']:
                                    ItemRef['name'] = QBO_item[p3]['Name']
                                    ItemRef['value'] = QBO_item[p3]['Id']
                                    continue
                            ...
                            if 'item_name' in multiple_invoice[i]['Item'][j]:
                                if multiple_invoice[i]['Item'][j]['item_name'].lower().strip()== QBO_item[p3]['Name'].lower().strip():
                                    ItemRef['name'] = QBO_item[p3]['Name']
                                    ItemRef['value'] = QBO_item[p3]['Id']
                                    break
                            ...
                            if multiple_invoice[i]['IsTaxInclusive'] == False:
                                ...
                                if multiple_invoice[i]['Subtotal'] >= 0:
                                    if 'ship_quantity' not in multiple_invoice[i]['Item'][j]:
                                        ...
                                        SalesItemLineDetail['Qty'] = multiple_invoice[i][
                                            'Item'][j]['ship_quantity']
                                    SalesItemLineDetail['UnitPrice'] = multiple_invoice[i]['Item'][j]['unit_price'] /(100 + taxrate1) * 100
            ...
            if multiple_invoice[i]['Subtotal'] >= 0:
                        ...
                        if count_of_items_not_found>0:
                            ...
                            if (start_date != '' and end_date != ''):
                                ...
                                if (inv_date1 >= start_date1) and (inv_date1 <= end_date1):
                                    post_data_in_qbo(url1, headers, payload,db['item_invoice'],_id,job_id,task_id, multiple_invoice[i]['invoice_no'])
                ...
                if "SalesItemLineDetail" in invoice["Line"][0]:
                    ...
                    if count_of_items_not_found>0:
                        ...
                        if (start_date != '' and end_date != ''):
                            if (inv_date1 >= start_date1) and (inv_date1 <= end_date1):
                                post_data_in_qbo(url2, headers, payload,db['item_invoice'],_id,job_id,task_id, multiple_invoice[i]['invoice_no'])
