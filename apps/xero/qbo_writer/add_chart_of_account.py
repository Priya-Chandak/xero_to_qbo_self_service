    ...
    try:
        ...
        for j in range(0, len(QuerySet1)):
            try:
                ...
                print(payload)
                post_data_in_qbo(url, headers, payload,dbname["xero_classified_coa"],_id, job_id,task_id, QuerySet1[j]["Name"])
    ...
    try:
        ...
        for j in range(0, len(QuerySet1)):
            try:
                ...
                payload = json.dumps(QuerySet1[j])
                print(payload)
                post_data_in_qbo(url, headers, payload,dbname["xero_classified_archived_coa"],_id, job_id,task_id, QuerySet1[j]["Name"])
