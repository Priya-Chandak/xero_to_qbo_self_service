...
def add_xero_bill(job_id, task_id):
    try:
        ...
        #     if final_bill[m]['Inv_No'] in ["6388/00190075"]: #'Martin Van Eldik','William Lane','June Lane']:#, '51 Artedomus Pickup VDW', '52 Nthside Pick up 99 Emerald', '2396200', '33921 Project: Stone Dev', '2405725', '2415018', '2423617', '0200', '58 99 Design Pick Up', '70 CDK Pick up', 'CMS Waterjet', '3100 Mirador', '2432910', '128 Emerald Repair', '430', '2442386', '0461']:
                        ...
                        if (len(final_bill[i]['Line']) >= 1):
                                ...
                                if 'AccountCode' in final_bill[i]['Line'][j]:
                                    if 'ItemCode' in final_bill[i]['Line'][j]:
                                        ...
                                        for k1 in range(0, len(QBO_tax)):
                                            if (final_bill[i]['Line'][j]['TaxType'] == 'BASEXCLUDED') or (
                                                    final_bill[i]['Line'][j]['TaxType'] == None) or (
                                                ...
                                                if 'taxrate_name' in QBO_tax[k1]:
                                                    if "NOTAXP" in QBO_tax[k1]['taxrate_name']:
                                                        ...
                                                        TaxLineDetail['NetAmountTaxable'] = final_bill[i]['Line'][j][
                                                                                                'UnitAmount'] - \
                                                                                            final_bill[i]['Line'][j][
                                                                                                'TaxAmount']
                                                        Tax['Amount'] = final_bill[i]['Line'][j]['TaxAmount']

                                            elif final_bill[i]['Line'][j]['TaxType'] in ['EXEMPTEXPENSES',
                                                                                         "EXEMPTOUTPUT", "INPUTTAXED",
                                                                                         "TAX001"]:
                                                if 'taxrate_name' in QBO_tax[k1]:
                                                ...
                                                if 'taxrate_name' in QBO_tax[k1]:
                                                    if "GST (purchases)" in QBO_tax[k1]['taxrate_name'] or "SI" in \
                                        ...
                                        for j3 in range(0, len(QBO_supplier)):
                                            if QBO_supplier[j3]["DisplayName"].startswith(
                                                    final_bill[i]["ContactName"]) and QBO_supplier[j3][
                                                ...
                                                QuerySet4["value"] = QBO_supplier[j3]["Id"]
                                                continue
                                            elif final_bill[i]['ContactName'].replace(":", "-") == QBO_supplier[j3][
                                                'DisplayName'].replace(":", "-"):
                                                QuerySet4["value"] = QBO_supplier[j3]["Id"]
                                                continue
                                            else:
                                        ...
                                        for p4 in range(0, len(QBO_item)):
                                            if "ItemCode" in final_bill[i]["Line"][j] and "AccountCode" in \
                                                    final_bill[i]["Line"][j]:
                                                if QBO_item[p4]["Name"].startswith(
                                                        final_bill[i]["Line"][j]["ItemCode"]) and QBO_item[p4][
                                                    "Name"].endswith(final_bill[i]["Line"][j]["AccountCode"]):
                                        ...
                                        for p3 in range(0, len(QBO_item)):
                                            ...
                                            elif "ItemCode" not in final_bill[i]["Line"][j] and "AccountCode" in \
                                                    final_bill[i]["Line"][j]:
                                                if "Sku" in QBO_item[p3]:
                                                    print("Sku")
                                                    if (
                                                    ...
                                                    if 'Code' in xero_coa1[j2]:
                                                        if 'AccountCode' in final_bill[i]['Line'][j]:
                                                            if 'AcctNum' in QBO_coa[j1]:
                                                                if final_bill[i]['Line'][j]['AccountCode'] == \
                                                                        QBO_coa[j1]["AcctNum"]:
                                                                    QuerySet3['value'] = QBO_coa[j1]["Id"]

                                                            elif final_bill[i]['Line'][j]['AccountCode'] == \
                                                                    xero_coa1[j2]["Code"]:
                                                                if xero_coa1[j2]["Name"].lower().strip() == QBO_coa[j1][
                                                                    "FullyQualifiedName"].lower().strip():
                                                                    QuerySet3['value'] = QBO_coa[j1]["Id"]
                            ...
                            if (start_date != '' and end_date != ''):
                                if (bill_date1 >= start_date1) and (bill_date1 <= end_date1):
                                    post_data_in_qbo(url1, headers, payload, db["xero_bill"], _id, job_id, task_id,
                                                     final_bill[i]['Inv_No'])
                            ...
                            for j in range(0, len(final_bill[i]['Line'])):
                                if 'AccountCode' in final_bill[i]['Line']:
                                    ...
                                    for j1 in range(0, len(QBO_item)):
                                        if ('ItemCode' in final_bill[i]['Line'][j]) and (
                                            ...
                                            if final_bill[i]['Line'][j]['ItemCode'] == xero_items[j2]['Code']:
                                                ...
                                                elif xero_items[j2]['Name'].replace(":", "-") + "-" + \
                                                        final_bill[i]['Line'][j]['AccountCode'] == QBO_item[j1]["Name"]:
                                                    ItemRef['value'] = QBO_item[j1]["Id"]
                                                    break
                                                ...
                                                elif final_bill[i]['Line'][j]['Name'].replace(":", "-").endswith(
                                                        QBO_item[j1]["Name"]):
                                                    ItemRef['value'] = QBO_item[j1]["Id"]
                                                    break


                                        elif ('ItemCode' not in final_bill[i]['Line'][j]) and (
                                                'AccountCode' in final_bill[i]['Line'][j]):
                                    ...
                                    for k1 in range(0, len(QBO_tax)):
                                        ...
                                        elif final_bill[i]['Line'][j]['TaxType'] in ['EXEMPTEXPENSES', "EXEMPTOUTPUT",
                                                                                     "INPUTTAXED", "TAX001"]:
                                            if 'taxrate_name' in QBO_tax[k1]:
                                                if "GST-free (purchases)" in QBO_tax[k1]['taxrate_name']:
                                                    TaxRate['value'] = QBO_tax[k1]['taxrate_id']
                                    ...
                                    for j3 in range(0, len(QBO_supplier)):
                                        if QBO_supplier[j3]["DisplayName"].startswith(final_bill[i]["ContactName"]) and \
                                ...
                                if (start_date != '' and end_date != ''):
                                    if (bill_date1 >= start_date1) and (bill_date1 <= end_date1):
                                        post_data_in_qbo(url2, headers, payload, db["xero_bill"], _id, job_id, task_id,
                                                         final_bill[i]['Inv_No'])
