    ...
    try:
        ...
        for i in range(0, len(QuerySet1)):
            ...
            if len(common_contact) > 0:
                ...
                elif ('FirstName' in QuerySet1[i]) and ('LastName' in QuerySet1[i]) and (
                        QuerySet1[i]['FirstName'] != None and QuerySet1[i]['LastName'] != None):
                    if QuerySet1[i]['Company_Name'] in common_contact1:
                        QuerySet2['DisplayName'] = QuerySet1[i]['FirstName'].replace(":", "-") + " " + QuerySet1[i][
                            'LastName'].replace(":", "-") + "-C"
                    else:
                        QuerySet2['DisplayName'] = QuerySet1[i]['FirstName'].replace(":", "-") + " " + QuerySet1[i][
                            'LastName'].replace(":", "-")
