...
def add_xero_supplier(job_id,task_id):
    try:
        ...
        for supplier in suppliers:
            ...
            QuerySet2["GivenName"] = supplier.get("FirstName").replace(":","-") if supplier.get("FirstName")!=None else None
            QuerySet2["FamilyName"] = supplier.get("LastName").replace(":","-") if supplier.get("LasttName")!=None else None
            ...
            if supplier.get("Website")!=None:
                QuerySet10["URI"] = supplier.get("Website") if supplier.get("Website").startswith("http") else 'https://'+supplier.get("Website")
            else:
                QuerySet10["URI"]=None
